...
void draw_main_menu(struct menu_t *menu)
{
    ...
    area_draw_string(menu->driver, &menu->areas[1],
        horizontal_str_offset(STR_START, button_rect.width, char_thickness),
        vertical_str_offset(STR_START, button_rect.height, char_thickness), 
        STR_START, 0xFFFF, char_thickness);
    
    // STOP button
    area_fill(menu->driver, &menu->areas[2], fill_color);
    area_draw_rectangle(menu->driver, &menu->areas[2], button_rect,
        outline_color, outline_thickness);
    area_draw_string(menu->driver, &menu->areas[2], 
        horizontal_str_offset(STR_STOP, button_rect.width, char_thickness),
        vertical_str_offset(STR_STOP, button_rect.height, char_thickness), 
        STR_STOP, 0xFFFF, char_thickness);
    
    // OPTIONS button
    area_fill(menu->driver, &menu->areas[3], fill_color);
    area_draw_rectangle(menu->driver, &menu->areas[3], button_rect,
        outline_color, outline_thickness);
    area_draw_string(menu->driver, &menu->areas[3], 
        horizontal_str_offset(STR_OPTIONS, button_rect.width, char_thickness),
        vertical_str_offset(STR_OPTIONS, button_rect.height, char_thickness),
        STR_OPTIONS, 0xFFFF, char_thickness);
}
