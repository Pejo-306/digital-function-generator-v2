...
${OBJECTDIR}/src/DFG-firmware/IOexpander_driver.o: src/DFG-firmware/IOexpander_driver.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/src/DFG-firmware" 
...
${OBJECTDIR}/src/hardcode.o: src/hardcode.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/hardcode.o.d 
	@${RM} ${OBJECTDIR}/src/hardcode.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega2561 ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -funsigned-char -funsigned-bitfields -O1 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -DF_CPU=16000000 -D_ILI9341_ -D_XPT2046_  -I "include" -Wall -MD -MP -MF "${OBJECTDIR}/src/hardcode.o.d" -MT "${OBJECTDIR}/src/hardcode.o.d" -MT ${OBJECTDIR}/src/hardcode.o  -o ${OBJECTDIR}/src/hardcode.o src/hardcode.c  -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 
