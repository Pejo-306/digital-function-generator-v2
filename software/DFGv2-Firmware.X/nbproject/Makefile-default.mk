...
SOURCEFILES_QUOTED_IF_SPACED=src/main.c src/init_mcu.c src/avr_controllers/spi_controller.c src/lcd-driver/lcd-driver.c src/lcd-driver/graphics.c src/touch-panel-driver/touch-panel-driver.c src/user-interface/ui_button.c src/user-interface/ui_main_menu.c src/user-interface/ui_helper.c src/user-interface/ui_options_menu.c src/avr_controllers/twi_controller.c src/DFG-firmware/DDS_firmware.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/main.o ${OBJECTDIR}/src/init_mcu.o ${OBJECTDIR}/src/avr_controllers/spi_controller.o ${OBJECTDIR}/src/lcd-driver/lcd-driver.o ${OBJECTDIR}/src/lcd-driver/graphics.o ${OBJECTDIR}/src/touch-panel-driver/touch-panel-driver.o ${OBJECTDIR}/src/user-interface/ui_button.o ${OBJECTDIR}/src/user-interface/ui_main_menu.o ${OBJECTDIR}/src/user-interface/ui_helper.o ${OBJECTDIR}/src/user-interface/ui_options_menu.o ${OBJECTDIR}/src/avr_controllers/twi_controller.o ${OBJECTDIR}/src/DFG-firmware/DDS_firmware.o
...
# Object Files
OBJECTFILES=${OBJECTDIR}/src/main.o ${OBJECTDIR}/src/init_mcu.o ${OBJECTDIR}/src/avr_controllers/spi_controller.o ${OBJECTDIR}/src/lcd-driver/lcd-driver.o ${OBJECTDIR}/src/lcd-driver/graphics.o ${OBJECTDIR}/src/touch-panel-driver/touch-panel-driver.o ${OBJECTDIR}/src/user-interface/ui_button.o ${OBJECTDIR}/src/user-interface/ui_main_menu.o ${OBJECTDIR}/src/user-interface/ui_helper.o ${OBJECTDIR}/src/user-interface/ui_options_menu.o ${OBJECTDIR}/src/avr_controllers/twi_controller.o ${OBJECTDIR}/src/DFG-firmware/DDS_firmware.o

# Source Files
SOURCEFILES=src/main.c src/init_mcu.c src/avr_controllers/spi_controller.c src/lcd-driver/lcd-driver.c src/lcd-driver/graphics.c src/touch-panel-driver/touch-panel-driver.c src/user-interface/ui_button.c src/user-interface/ui_main_menu.c src/user-interface/ui_helper.c src/user-interface/ui_options_menu.c src/avr_controllers/twi_controller.c src/DFG-firmware/DDS_firmware.c
...
${OBJECTDIR}/src/avr_controllers/twi_controller.o: src/avr_controllers/twi_controller.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/src/avr_controllers" 
	@${RM} ${OBJECTDIR}/src/avr_controllers/twi_controller.o.d 
	@${RM} ${OBJECTDIR}/src/avr_controllers/twi_controller.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega2561 ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -funsigned-char -funsigned-bitfields -O1 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -DF_CPU=16000000 -D_ILI9341_ -D_XPT2046_  -I "include" -Wall -MD -MP -MF "${OBJECTDIR}/src/avr_controllers/twi_controller.o.d" -MT "${OBJECTDIR}/src/avr_controllers/twi_controller.o.d" -MT ${OBJECTDIR}/src/avr_controllers/twi_controller.o  -o ${OBJECTDIR}/src/avr_controllers/twi_controller.o src/avr_controllers/twi_controller.c  -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 
	
${OBJECTDIR}/src/DFG-firmware/DDS_firmware.o: src/DFG-firmware/DDS_firmware.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/src/DFG-firmware" 
	@${RM} ${OBJECTDIR}/src/DFG-firmware/DDS_firmware.o.d 
	@${RM} ${OBJECTDIR}/src/DFG-firmware/DDS_firmware.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega2561 ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -funsigned-char -funsigned-bitfields -O1 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -DF_CPU=16000000 -D_ILI9341_ -D_XPT2046_  -I "include" -Wall -MD -MP -MF "${OBJECTDIR}/src/DFG-firmware/DDS_firmware.o.d" -MT "${OBJECTDIR}/src/DFG-firmware/DDS_firmware.o.d" -MT ${OBJECTDIR}/src/DFG-firmware/DDS_firmware.o  -o ${OBJECTDIR}/src/DFG-firmware/DDS_firmware.o src/DFG-firmware/DDS_firmware.c  -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 
